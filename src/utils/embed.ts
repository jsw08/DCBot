...
export const embed = (parms: EmbedParams): EmbedBuilder  => {
	...
	iconURL: "https://cdn.discordapp.com/avatars/809362634947690527/f14201f0d5ee26fa0c73fd2f3828ee28.png"
    })
    parms.kindOfEmbed && embed.setColor(
	ColorKinds[parms.kindOfEmbed]	
    )
